...
함께 읽을 파일: [src/main/java/com/example/fatdogai/presentation/controller/BaseController.java](<../../FatDogAI/src/main/java/com/example/fatdogai/presentation/controller/BaseController.java>) · [src/main/java/com/example/fatdogai/presentation/controller/ChatController.java](<../../FatDogAI/src/main/java/com/example/fatdogai/presentation/controller/ChatController.java>) · [src/main/java/com/example/fatdogai/application/port/ChatRepository.java](<../../FatDogAI/src/main/java/com/example/fatdogai/application/port/ChatRepository.java>)
