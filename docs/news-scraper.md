...
함께 읽을 파일: [src/oop/search/application/NewsService.java](<../../news-scraper/src/oop/search/application/NewsService.java>) · [src/oop/search/application/NewsProvider.java](<../../news-scraper/src/oop/search/application/NewsProvider.java>) · [src/oop/search/application/NewsPublisher.java](<../../news-scraper/src/oop/search/application/NewsPublisher.java>)
