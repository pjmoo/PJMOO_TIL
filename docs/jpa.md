...
함께 읽을 파일: [src/main/java/org/example/jpa/controller/MainController.java](<../../jpa/src/main/java/org/example/jpa/controller/MainController.java>) · [src/main/java/org/example/jpa/JpaApplication.java](<../../jpa/src/main/java/org/example/jpa/JpaApplication.java>) · [src/main/java/org/example/jpa/repository/BookRepository.java](<../../jpa/src/main/java/org/example/jpa/repository/BookRepository.java>)
